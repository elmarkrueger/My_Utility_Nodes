// ComfyUI.mytoolkit.CFGGuider v.1.0.0 - Elmar Krüger 2025
...
class MXCFGGuider
{
    constructor(node)
    {
        ...
        this.node.properties.value=7.0;
        this.node.properties.min=0.0;
        this.node.properties.max=12.0;
        this.node.properties.step=0.1;
        this.node.properties.decimals=1;
        ...
        this.node.onAdded = function ()
        {
            ...
            this.widgets_start_y = -2.4e8*LiteGraph.NODE_SLOT_HEIGHT; // Hide widgets area
        ...
        this.node.onPropertyChanged = function (propName)
        {
            ...
            if (this.properties.step <= 0) this.properties.step = 0.1;
...
app.registerExtension(
{
    ...
    {
        if (nodeData.name === "mxCFGGuider")
        {
            const onNodeCreated = nodeType.prototype.onNodeCreated;
            nodeType.prototype.onNodeCreated = function () {
                if (onNodeCreated) onNodeCreated.apply(this, []);
                this.mxCFGGuider = new MXCFGGuider(this);
            }
        }
    }
});
